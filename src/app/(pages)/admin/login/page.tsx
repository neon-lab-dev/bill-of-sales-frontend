        ...
        <div className='flex h-full w-full overflow-hidden'>
            <div className=' flex flex-col w-1/2 p-[140px] bg-white'>
                ...
                <div class="relative mb-6 ml-16">
                    ...
                    <input type="text" id="input-group-1" class=" text-lg rounded-lg block border w-[400px] ps-10 p-2.5 placeholder:text-[#333333] " placeholder="name@flowbite.com" />
                </div>
                <div class="relative mb-6 ml-16">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                ...
                <div className=' flex justify-center text-center ml-8'>
                    <button  className=' text-white bg-[#3E6FBF] p-4 rounded-xl ml-2 text-center w-[400px]'><span className=' text-center'>Login</span></button>
                </div>
            </div>
